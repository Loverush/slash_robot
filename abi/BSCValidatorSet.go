...
// INITFINALITYREWARDRATIO is a free data retrieval call binding the contract method 0xd04aa996.
//
// Solidity: function INIT_FINALITY_REWARD_RATIO() view returns(uint256)
func (_Validatorset *ValidatorsetCaller) INITFINALITYREWARDRATIO(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Validatorset.contract.Call(opts, &out, "INIT_FINALITY_REWARD_RATIO")
...
//
// Solidity: function INIT_FINALITY_REWARD_RATIO() view returns(uint256)
func (_Validatorset *ValidatorsetSession) INITFINALITYREWARDRATIO() (*big.Int, error) {
	return _Validatorset.Contract.INITFINALITYREWARDRATIO(&_Validatorset.CallOpts)
}

// INITFINALITYREWARDRATIO is a free data retrieval call binding the contract method 0xd04aa996.
//
// Solidity: function INIT_FINALITY_REWARD_RATIO() view returns(uint256)
func (_Validatorset *ValidatorsetCallerSession) INITFINALITYREWARDRATIO() (*big.Int, error) {
	return _Validatorset.Contract.INITFINALITYREWARDRATIO(&_Validatorset.CallOpts)
}
...
// FinalityRewardRatio is a free data retrieval call binding the contract method 0x549b03f2.
//
// Solidity: function finalityRewardRatio() view returns(uint256)
func (_Validatorset *ValidatorsetCaller) FinalityRewardRatio(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Validatorset.contract.Call(opts, &out, "finalityRewardRatio")
...
//
// Solidity: function finalityRewardRatio() view returns(uint256)
func (_Validatorset *ValidatorsetSession) FinalityRewardRatio() (*big.Int, error) {
	return _Validatorset.Contract.FinalityRewardRatio(&_Validatorset.CallOpts)
}

// FinalityRewardRatio is a free data retrieval call binding the contract method 0x549b03f2.
//
// Solidity: function finalityRewardRatio() view returns(uint256)
func (_Validatorset *ValidatorsetCallerSession) FinalityRewardRatio() (*big.Int, error) {
	return _Validatorset.Contract.FinalityRewardRatio(&_Validatorset.CallOpts)
}
